...
LRESULT CALLBACK WindowProc(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam)
{
	...
	case WM_CREATE:
		...
		srand(time(NULL));
		edit1 = CreateWindowEx(WS_EX_CLIENTEDGE, "EDIT", "PRESIONA N PARA OBTENER ", WS_VISIBLE | WS_CHILD | WS_BORDER | ES_LEFT, 100, 100, 30, 15, hWnd, (HMENU)302, GetModuleHandle(NULL), 0);
